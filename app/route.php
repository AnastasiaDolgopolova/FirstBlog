...
$dispatcher = FastRoute\simpleDispatcher(function(FastRoute\RouteCollector $r) {
    ...
    $r->addRoute('GET', '/Categories', ['App\controllers\HomeController', 'categories']);
    ...
    $r->addRoute('GET', '/category-posts/{id:\d+}', ['App\controllers\CategoryController', 'showPosts']);
    ...
    $r->addRoute('POST', '/edit_avatar', ['App\controllers\UserController', 'changeAvatar']);
